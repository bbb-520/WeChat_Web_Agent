...
public class TtsTool {
    ...
    public ActResult synthesize(
        ...
        try {
            ...
            // 使用默认用户ID合成（工具调用时没有具体用户上下文）
            String voiceId = timbreSession.getCurrentVoiceId("default");
    ...
    public ActResult switchVoice(
        ...
        try {
            ...
            if (t != null) {
                timbreSession.switchTo("default", t);
            ...
            try {
                ...
                if (byNumber != null) {
                    timbreSession.switchTo("default", byNumber);
