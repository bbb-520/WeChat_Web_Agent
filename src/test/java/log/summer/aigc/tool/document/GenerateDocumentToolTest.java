...
class GenerateDocumentToolTest {
    ...
    void shouldGenerateDocumentFromConfirmedOutline() {
        ...
        // Act
        ActResult result = tool.generateDocument("PPT", 100L);
    ...
    void shouldReturnExistingDocumentWhenIdempotent() {
        ...
        // Act
        ActResult result = tool.generateDocument("WORD", 100L);
    ...
    void shouldReturnFailureForMissingOutline() {
        ...
        ActResult result = tool.generateDocument("PPT", 999L);
    ...
    @Test
    void shouldReturnFailureWhenUserContextMissing() {
        // Arrange: outline is confirmed but no user context is set
        UserContextHolder.clear();
        ...
        assertFalse(result.success());
        assertTrue(result.errorMessage().contains("无法识别当前用户"));
    }
}
