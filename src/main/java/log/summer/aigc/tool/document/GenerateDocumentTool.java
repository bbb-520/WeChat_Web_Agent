 ...
 * The {@code userId} and {@code conversationId} parameters have been
 * removed from this tool's signature because the LLM cannot supply them
 * reliably. The values are now read from {@link UserContextHolder}
 * which is populated by {@code AgentLoop} before any tool runs.
 *
 * @author bbb
 * @since 2026-07-28
 */
...
public class GenerateDocumentTool {
    ...
    public ActResult generateDocument(
        ...
        // ThreadLocal instead of asking the LLM to fill them in.
